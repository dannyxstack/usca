    ...
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="tab-content">
            ...
            <div class="">
              ...
              <div class="row">
                  <div class="col-md-4 text-end">
                    <img src="/svg/Vector Header-07.svg" alt="Support illustration" class="img-fluid" style="max-height: 300px;">
                  </div>
                  <div class="col-md-8 pt-5">
                    <h2 class="color-darkblue pt-5 fs-3" >Entry Requirements</h2>
                    <p class="fs-6">{{ $course->entry_req_desc }}</p>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="course-requirement-box">
                      ...
                      <div class="px-2 fs-6 mt-2 text-start px-5">
                        <div class="px-2">
                      ...
                      <div class="px-2 py-2" style="background-color: #e7e7fb; @if (empty($course->entry_req_notes)) display: none; @endif" >
                        <div class="px-5">
                          ...
                          <p class="color-darkblue fs-4"><svg viewBox="0 0 57.5 70.3599" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="57.500000" height="70.359863" fill="none" customFrame="#000000">
                          ...
                          <p class="fs-6">{!! nl2br(e($course->entry_req_notes)) !!}</p>
                        </div>
          ...
          <section class="course-requirement-gray-bg tab-pane fade" id="entryreq" style="display: none;">
              ...
              <div class="container py-4">
                <div class="row">
                  ...
                  <div class="col-md-6 pt-5">
                    <h2 class="color-darkblue mt-5 pt-5 fs-3" >Entry Requirements</h2>
                    <p class="fs-6">{{ $course->entry_req_desc }}</p>
                  </div>
                </div>
                <div class="row">
          ...
          <section class="tab-pane fade" id="resources" style="display: none;">
            <div class="">
              <div class="container ">
                <div class="row">
                  <!-- <div class="col-md-1"></div> -->
          ...
          <section class="tab-pane fade" id="policy" style="display: none;">
            <div class="">
              <div class="container ">
                <div class="row">
                  <!-- <div class="col-md-1"></div> -->
